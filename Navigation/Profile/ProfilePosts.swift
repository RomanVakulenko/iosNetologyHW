...
class ProfilePosts {
    ...
    init(title: String, image: String, description: String, likes: Int, views: Int) {
        self.title = title
        self.image = image
    ...
    static func createProfilePosts() -> [ProfilePosts]{
        ...
        let post1st = ProfilePosts(title: "Simba", image: "Bengal",
        ...
        let post2nd = ProfilePosts(title: "Persi", image: "FoxTerrier",
        ...
        let post3rd = ProfilePosts(title: "Mouse", image: "Jerry",
        ...
        let post4th = ProfilePosts(title: "Tom", image: "Tom",
